          ...
          <div className="grid lg:grid-cols-[8fr_2fr] gap-16 items-stretch">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-xl opacity-95 leading-relaxed mb-4">
                MaSubventionPro est une plateforme d'intelligence artificielle qui aide les créateurs, repreneurs, dirigeants d'entreprises, groupes et associations à identifier toutes les aides publiques disponibles : subventions, prêts,<br />garanties, exonérations fiscales et dispositifs territoriaux.
              </p>

              <p className="text-xl opacity-95 leading-relaxed mb-6">
                Notre IA analyse en temps réel des milliers de dispositifs nationaux, régionaux, communaux et européens,<br />calcule un score d'éligibilité et génère des rapports détaillés.
              </p>
            ...
            {[
              {
                ...
                title: "Matching IA précis",
                desc: "Nos algorithmes analysent votre profil (activité, secteur, effectifs, localisation, projets) et identifient les dispositifs pertinents parmi les aides disponibles.",
                highlight: "Score d'éligibilité calculé pour chaque aide",
              },
              {
                icon: <BarChart3 className="w-8 h-8 text-white" />,
                title: "Intelligence historique",
                desc: "Montants attribués (min, max, moyenne) par aide, nombre d'attributions et activité sur les 12 derniers mois. Statistiques calculées si informations disponibles.",
                highlight: "Données sur 3 ans",
              },
              {
                icon: <Search className="w-8 h-8 text-white" />,
                title: "Moteur de recherche",
                desc: "Explorez librement les dispositifs avec filtres avancés : région, secteur, dispositif, montant, échéance. Trouvez les aides publiques adaptées à votre situation.",
                highlight: "Recherche textuelle + multi-filtres",
              },
              {
                icon: <Bot className="w-8 h-8 text-white" />,
                title: "Assistant IA expert",
                desc: "Décrivez votre projet, l'IA analyse votre profil, interroge la base subvention360 et vous suggère les aides les plus pertinentes. Posez toutes vos questions.",
                highlight: "Réponses avec références officielles",
              },
              {
              ...
              },
              {
                ...
                desc: "Soyez notifié lorsqu'un nouveau dispositif correspond à votre profil. Ne manquez plus une opportunité, nous vous informons par email (une fois par mois maximum).",
                highlight: "Votre veille automatique (offre annuelle)",
              },
            ].map((feature, i) => (
              <div
                key={i}
